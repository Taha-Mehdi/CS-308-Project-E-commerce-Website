...
--> statement-breakpoint
ALTER TABLE "wishlist_items" ADD CONSTRAINT "wishlist_items_user_id_users_id_fk"
...
--> statement-breakpoint
CREATE UNIQUE INDEX "unique_user_product_wishlist" ON "wishlist_items" USING btree ("user_id","product_id");
--> statement-breakpoint
