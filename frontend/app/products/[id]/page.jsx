...
/**
 * Discount helpers:
 * Supports a few common shapes (percent off / sale price / discounted price).
 */
    ...
    <GlassCard className="p-5">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="shrink-0 flex flex-col items-end gap-2">
          ...
          {pending && (
            <span className="inline-flex items-center rounded-full px-3 py-1 border border-white/10 bg-black/20 text-[10px] uppercase tracking-[0.22em] text-white/65">
              pending
            </span>
          )}
        </div>
          ...
          <>
            ...
            <section className="relative overflow-hidden rounded-[44px] border border-white/10 bg-white/[0.03] backdrop-blur p-4 sm:p-6 shadow-[0_18px_70px_rgba(0,0,0,0.38)]">
              ...
              <div className="relative grid gap-6 lg:grid-cols-[1.25fr_0.75fr] items-stretch">
                ...
                {/* RIGHT: details card (wishlist moved DOWN) */}
                <div className="h-full">
                  <GlassCard className="p-5 sm:p-6 h-full">
                    <div className="h-full flex flex-col">
                      {/* Title (full width now, no wishlist beside it) */}
                      <div>
